...
class DiMPActor(BaseActor):
    ...
    def __call__(self, data,is_arch=False):
        """
        args:
        ...
        """
        # Run network
        target_scores, iou_pred, reg = self.net(train_imgs=data['train_images'],
...
class KLDiMPActor(BaseActor):
    ...
    def __call__(self, data,is_search=False):
        """
        args:
            data - The input data, should contain the fields 'train_images', 'test_images', 'train_anno',
                    'test_proposals', 'proposal_iou' and 'test_label'.
        ...
        """
        # Run network
        target_scores, bb_scores,_ = self.net(train_imgs=data['train_images'],
                                            test_imgs=data['test_images'],
                                            train_bb=data['train_anno'],
                                            test_proposals=data['test_proposals'])
