...
#
#     params.sample_memory_size_mtl = 5
#     params.learning_rate_mtl = 0.01
#     params.init_samples_minimum_weight_mtl = 0.25
#
...
#     params.target_not_found_threshold = 0.28 # 0.04
#     params.distractor_threshold = 0.8
#     params.hard_negative_threshold = 0.4
#     params.target_neighborhood_scale = 2.2 #2.2
...
#     params.iounet_k = 3                     # 3 Top-k average to estimate final box
#     params.num_init_random_boxes = 9        # Num extra random boxes in addition to the classifier prediction
#     params.box_jitter_pos = 0.1             # 0.1 How much to jitter the translation for random boxes
#     params.box_jitter_sz = 0.5              # 0.5 How much to jitter the scale for random boxes
#     # params.box_jitter_pos_mtl = 0  # 0.1 How much to jitter the translation for random boxes
#     # params.box_jitter_sz_mtl = 0  # 0.5 How much to jitter the scale for random boxes
...
#     params.box_refinement_step_length = 2.5e-3 # 2.5e-3 # 1   # Gradient step length in the bounding box refinement
...
def parameters():
    ...
    params.advanced_localization = True
    params.score_preprocess = 'softmax'
    params.target_not_found_threshold = 0.044
    params.distractor_threshold = 0.7
